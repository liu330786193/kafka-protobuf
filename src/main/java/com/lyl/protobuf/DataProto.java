...
public final class DataProto {
  ...
  public  static final class data extends
    ...
    protected FieldAccessorTable
      ...
      return DataProto.internal_static_data_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              DataProto.data.class, DataProto.data.Builder.class);
    }
    ...
    public boolean equals(final Object obj) {
      ...
      if (!(obj instanceof DataProto.data)) {
        return super.equals(obj);
      }
      DataProto.data other = (DataProto.data) obj;
    ...
    public static DataProto.data parseFrom(
    ...
    public static DataProto.data parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static DataProto.data parseFrom(
    ...
    public static DataProto.data parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static DataProto.data parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static DataProto.data parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(DataProto.data prototype) {
    ...
    public static final class Builder extends
      ...
      // Construct using com.lyl.protobuf.grpc.DataProto.data.newBuilder()
      private Builder() {
      ...
      public DataProto.data getDefaultInstanceForType() {
        return DataProto.data.getDefaultInstance();
      }

      public DataProto.data build() {
        DataProto.data result = buildPartial();
      ...
      public DataProto.data buildPartial() {
        DataProto.data result = new DataProto.data(this);
        result.id_ = id_;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof DataProto.data) {
          return mergeFrom((DataProto.data)other);
        } else {
      ...
      public Builder mergeFrom(DataProto.data other) {
        if (other == DataProto.data.getDefaultInstance()) return this;
        if (other.getId() != 0L) {
          setId(other.getId());
        }
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        DataProto.data parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (DataProto.data) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final DataProto.data DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new DataProto.data();
    }

    public static DataProto.data getDefaultInstance() {
  ...
  static {
    String[] descriptorData = {
      ...
      "ltitude\030\007 \001(\005\022\017\n\007locType\030\010 \001(\005\022\021\n\tgpsSta" +
      "tus\030\t \001(\005\022\021\n\tdirection\030\n \001(\002\022\021\n\tsatellit" +
      "e\030\013 \001(\005B\"\n\025com.lyl.protobuf.grpcB\tDataPr" +
      "otob\006proto3"
    };
